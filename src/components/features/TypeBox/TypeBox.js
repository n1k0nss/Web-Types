...
const TypeBox = ({
  ...
  const [wordsDict, setWordsDict] = useState(() => {
    ...
    if (language === UKRAINIAN_MODE) {
      return chineseWordsGenerator(difficulty, UKRAINIAN_MODE);
    }
  });
  ...
  return (
    <main onClick={handleInputFocus}>
          ...
          <Grid container justifyContent="center" alignItems="center">
            ...
            {menuEnabled && (
              <Box display="flex" flexDirection="row">
                ...
                <IconButton
                  onClick={() => {
                    reset(countDownConstant, difficulty, UKRAINIAN_MODE, false);
                  }}
                >
                  <Tooltip title={UKRAINIAN_MODE_TOOLTIP_TITLE}>
                    <span className={getLanguageButtonClassName(UKRAINIAN_MODE)}>
                      ukr
                    </span>
                  </Tooltip>
                </IconButton>
      ...
      >
        <DialogTitle>
          <div>
            <span className="key-note"> натисніть </span>
            <span className="key-type">Space</span>{" "}
            <span className="key-note">щоб повернутись</span>
          </div>
          <div>
            <span className="key-note"> натисніть </span>
            ...
            <span className="key-note">для перезапуску</span>
          </div>
          <span className="key-note"> натисніть </span>
          <span className="key-type">будь яку клавішу </span>{" "}
