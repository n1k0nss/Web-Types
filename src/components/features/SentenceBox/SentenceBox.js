            ...
            <Box display="flex" flexDirection="row">
              ...
              {menuEnabled && (
                <>
                  ...
                  <IconButton
                    onClick={() => {
                      reset(sentencesCountConstant, UKRAINIAN_MODE, false);
                    }}
                  >
                    <Tooltip title={UKRAINIAN_SENTENCE_MODE_TOOLTIP_TITLE}>
                      <span
                        className={getLanguageButtonClassName(UKRAINIAN_MODE)}
                      >
                        ukr
                      </span>
                    </Tooltip>
      ...
      >
        <DialogTitle>
          ...
          <div>
            ...
            <span className="key-note">щоб перезапустити</span>
          </div>
          <span className="key-note"> натисніть </span>
